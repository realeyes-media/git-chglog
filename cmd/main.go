...
// Execute : A replacement for Main so we can call this mess like a proper library
func Execute() {
...
// ExecuteSemVer : A replacement for Main so we can call this mess like a proper library, but with SemVer protections
func ExecuteSemVer() {
	ttl := color.New(color.FgYellow).SprintFunc()
